(function ($) {
    ...
    $(".btn-num-product-down").on("click", function () {
        var numProduct = Number(
            $(this).closest(".wrap-num-product").find(".num-product").val()
        );
        if (numProduct > 0) {
            $(this)
                .closest(".wrap-num-product")
                .find(".num-product")
                .val(numProduct - 1);
        }
    });
    ...
    function updateQuantityDisplay() {
        ...
        $("#quantity-display").text(numProduct);
    }

    $(document).ready(function () {
        updateQuantityDisplay(); // Gọi hàm khi trang được tải
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        showModalButtons.forEach(function (button) {
            button.addEventListener("click", function (event) {
                ...
                document.querySelector(".js-name-detail").innerText =
                    productName;
...
function shareOnGooglePlus() {
    var currentUrl = window.location.href;
    var googlePlusShareUrl =
        "https://plus.google.com/share?url=" + encodeURIComponent(currentUrl);
